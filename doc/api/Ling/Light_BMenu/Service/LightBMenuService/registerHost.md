...
Source Code
===========
See the source code for method [LightBMenuService::registerHost](https://github.com/lingtalfi/Light_BMenu/blob/master/Service/LightBMenuService.php#L146-L149)
